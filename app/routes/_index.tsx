...
export default function Home() {
  return (
    <section className="bg-gray-900 text-white h-max">
      <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
        <div className="mx-auto max-w-lg text-center">
          <h2 className="text-3xl font-bold sm:text-4xl">Nylas v3 Scheduler</h2>
          ...
          <p className="mt-4 text-gray-300">
            ...
            applications. With the v3 Scheduler API and Scheduler UI Components,
            you can manage bookings, design complex scheduling flows, customize
            the UI, and much more.
          </p>
        </div>
        ...
        <div className="mt-8 grid grid-cols-3 gap-8 md:grid-cols-2 sm:grid-cols-3">
          ...
          <a
            ...
            rel="noreferrer"
          >
            <h2 className="mt-4 text-xl font-bold text-white">Release Notes</h2>
          </a>
          ...
          <a
            ...
            rel="noreferrer"
          >
            <h2 className="mt-4 text-xl font-bold text-white">API Reference</h2>
          </a>
        </div>
      </div>
    </section>
